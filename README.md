...
not picked. Once more than one form is unlocked, an **evolution** dropdown
appears under settings to roll back to an earlier form (pick the latest form
to evolve again). Sprites are chibi pixel maps
